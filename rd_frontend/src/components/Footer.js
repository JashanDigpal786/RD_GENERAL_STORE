          ...
          <div className="pb-4 mb-4" style={{ borderBottom: "1px solid rgba(226, 175, 24, 0.5)" }}>
            <div className="row g-4">
              <div className="col-lg-3">
                <a href="#">
                  <h1 className="text-primary mb-0">RD Store</h1>
                  <p className="text-secondary mb-0">Shop Easily</p>
                </a>
              </div>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-item">
                ...
                <p>Address: 143529, Tibber, Gurdaspur, Punjab</p>
                <p>Email: jashan8847683268@gmail.com</p>
                <p>Phone: +91 8847683268</p>
          ...
          <div className="row">
            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
              <span className="text-light">
                <a href="#">  <i className="fas fa-copyright text-light me-2" />  RD Store</a>
                , All right reserved.
              </span>
            </div>

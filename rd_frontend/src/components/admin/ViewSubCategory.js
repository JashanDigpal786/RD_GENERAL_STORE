...
function ViewSubCategory() {
  ...
  const deleteData = (id) => {
    axios
      .post("http://localhost:4000/api/subcategory/delete", { _id: id })
      .then((res) => {
        res.data.success
  ...
  return (
    <>
      {/* Header section same as ViewCategory */}
      <div
      ...
      >
        ...
        >
          <h1 className="display-4 fw-bold text-white mb-3">Sub Categories</h1>
      ...
      {/* Table section with light red background */}
                  ...
                  data.map((el, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        <Link
                          to={`/admin/updatesubcategory/${el._id}`}

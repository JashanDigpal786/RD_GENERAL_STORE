          ...
          <nav className="navbar navbar-light bg-white navbar-expand-xl">
            ...
            <div className="collapse navbar-collapse bg-white" id="navbarCollapse">
              <div className="navbar-nav mx-auto">
                  <Link to="/admin/dashboard" className="nav-item nav-link">Dashboard </Link>
                ...
                <div className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu rounded-0 border-0 shadow-sm animate__animated animate__fadeIn">
                    ...
                    <Link to="/admin/viewproduct" className="dropdown-item">View</Link>
                  </div>

                </div>
                  <Link to="/admin/viewuser" className="nav-item nav-link"> User </Link>

                  <Link to="/admin/viewbooking" className="nav-item nav-link"> Booking </Link>
